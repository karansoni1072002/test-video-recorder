        ...
        <div className='relative'>
            {isOpen ? (
                <div className="w-full h-full fixed top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center">
                    ...
                    <div className="relative z-10 md:w-[33.75rem] w-full p-[0px] shadow shadow-borderGradient1 rounded-lg bg-gradient-to-b from-borderGradient1 via-white to-borderGradient1">
